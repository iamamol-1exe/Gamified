      ...
      <div className="flex flex-col items-center space-y-2">
          ...
          <div className="flex items-center space-x-2">
            ...
            >
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
                d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.905l-7.228 4.797a2.25 2.25 0 01-2.174 0L2.97 8.452a2.25 2.25 0 01-1.07-1.905V6.75"
              />
            </svg>
          ...
          <div className="flex items-center space-x-2">
            ...
            >
              ...
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
                d="M19.5 10.5c0 3.75-6 8.25-6 8.25s-6-4.5-6-8.25a6 6 0 0112 0z"
              />
            </svg>
            <p>{user && user.location ? user.location : "Location"}</p>
          </div>
          <div className="flex items-center space-x-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="space-y-2 text-center mt-4">
          ...
          <p className="text-gray-600">
            {user && user.class
              ? `Student in Standard ${user.class}`
              : "Student"}{" "}
            from {user && user.schoolName ? user.schoolName : "school"}
          </p>
        </div>
