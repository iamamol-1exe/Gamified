...
import { BellIcon } from "../shapes/DashBoardShapes"; // Make sure this import is correct
  ...
  return (
    <header className="bg-[#D0B9FF] shadow-sm p-4 flex justify-between items-center">
      ...
      <div className="flex items-center space-x-6">
        {/* The Notification Bell is only visible when the user is logged in */}
        {isAuthenticated && (
          <div className="relative">
            <button onClick={() => setNotificationOpen(!isNotificationOpen)} className="relative text-gray-600">
        ...
        {/* The Profile Icon is now always visible */}
        <div className="relative">
          <button onClick={() => setProfileOpen(!isProfileOpen)} className="block">
            <img
