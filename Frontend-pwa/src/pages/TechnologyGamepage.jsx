...
const TechnologyGamepage = () => {
  const games = [
    ...
    {
      title: "Slove Coding questions",
      description:
        "Embark on an adventure where you solve Technology problems to progress through levels.",
      difficulty: 3,
      points: 50,
  ...
  return (
    <div className="bg-gray-100 min-h-screen font-sans p-4 sm:p-8 flex flex-col items-center justify-center">
      <h1 className="text-3xl font-bold text-black mb-8">Technology Games</h1>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl">
        {games.map((game, index) => (
          <GameCard subject="Technology" key={index} {...game} />
        ))}
      </div>
    </div>
  );
...
export default TechnologyGamepage;
