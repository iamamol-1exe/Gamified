...
const StudentQuiz = () => {
  ...
  return (
    <div className="bg-gray-100 min-h-screen flex flex-col items-center py-8">
      ...
      <main className="container bg-white rounded-xl shadow-lg p-8 w-full max-w-4xl">
        {!isQuizComplete ? (
          <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {currentQuestion?.options.map((option, index) => (
                  <div
                    ...
                    className={`option px-4 py-4 rounded-lg font-medium ${
            ...
            <div className="flex justify-between mt-8">
              <button
                ...
                className={`px-6 py-3 bg-gray-200 text-gray-700 font-bold rounded-lg transition duration-200 hover:bg-gray-300 focus:outline-none ${
          ...
          <div className="flex flex-col items-center justify-center p-8 text-center">
            ...
            <p className="text-lg text-gray-700 mb-6">
              Thank you for completing the quiz. You can now submit your
              answers.
            </p>
            <button
      ...
      {message && (
        <MessageModal message={message} onOk={() => setMessage(null)} />
      )}
    </div>
  );
};
