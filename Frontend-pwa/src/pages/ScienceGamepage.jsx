...
const ReactionBalancerImage = () => (
  <svg viewBox="0 0 300 100" className="w-full h-32 object-contain p-4">
    {/* ... your SVG content for the balancer image ... */}
    ...
    <polyline points="105,45 110,50 105,55" fill="none" stroke="#6B7280" strokeWidth="2" />
    <g transform="translate(130, 40)">
      <circle cx="10" cy="10" r="7" fill="none" stroke="#9CA3AF" strokeWidth="1.5" />
      <circle cx="25" cy="10" r="7" fill="none" stroke="#9CA3AF" strokeWidth="1.5" />
    </g>
    <g transform="translate(130, 60)">
      <circle cx="10" cy="10" r="7" fill="none" stroke="#9CA3AF" strokeWidth="1.5" />
      <circle cx="25" cy="10" r="7" fill="none" stroke="#9CA3AF" strokeWidth="1.5" />
    </g>
    <text x="190" y="58" fontSize="24" textAnchor="middle" fill="#6B7280">+</text>
    <g transform="translate(220, 45)">
      <circle cx="12" cy="12" r="10" fill="#F87171" />
      <circle cx="38" cy="12" r="10" fill="#F87171" />
    </g>
  </svg>
);
...
const MoleculeManiaImage = () => (
  <svg viewBox="0 0 200 150" className="w-full h-32 object-contain p-4">
    {/* ... your SVG content for the molecule image ... */}
    <defs>
      <radialGradient id="gradRed" cx="30%" cy="30%" r="70%" fx="30%" fy="30%">
        <stop offset="0%" style={{ stopColor: "rgb(255,255,255)", stopOpacity: 0.7 }} />
        <stop offset="100%" style={{ stopColor: "rgb(239, 68, 68)", stopOpacity: 1 }} />
      </radialGradient>
      <radialGradient id="gradWhite" cx="30%" cy="30%" r="70%" fx="30%" fy="30%">
...
const ScienceGamepage = () => {
  // Define the data for each card, including the destination route
  const games = [
    {
      title: "Solve MCQ",
      description:
      ...
      route: "/studentquiz", // Add the route for the quiz
    },
    {
